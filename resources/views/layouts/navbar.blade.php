<div class="sidebar close"  >
    <div class="logo-details">
      ...
      <span class="logo_name">ATMPI Dashboard</span>
    </div>
    <ul class="nav-links">
      <li>
        <a href="#">
      ...
      <li>
        ...
        <ul class="sub-menu" style="font-size: 200px">
          <li><a class="link_name" href="#">ENGINEERING</a></li>
          <li><a href="#" >IT Request Ticketing</a></li>
        </ul>
      </li>
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="#">Timekeeping Summary</a></li>
        </ul>
      </li>
